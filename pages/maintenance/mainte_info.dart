...
class MaintenInfo extends StatefulWidget {
  @override
  _MaintenInfoState createState() => _MaintenInfoState();
  final String req_id;
  MaintenInfo(this.req_id);
}

class _MaintenInfoState extends State<MaintenInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    maintenances =  (
        ...
        LoadSettings.getMaintenancesList().where((i) => i.request_id==widget.req_id).toList()
            :LoadSettings.getMaintenancesManagerList().where((i) => i.request_id==widget.req_id).toList()
    );
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("mainte_info".tr, style: ScreenUtils.geHeaderextstyle()),
        centerTitle: true,
